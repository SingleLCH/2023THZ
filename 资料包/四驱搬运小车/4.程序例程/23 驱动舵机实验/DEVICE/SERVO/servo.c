...
{	
	...
	TIM1_PWM_Init(9999,71); //72分频,PWM频率=72000000/(71+1)/(9999+1)=100hz 周期10ms
	TIM1->CCR1=0;				//设置占空比
	TIM1->CCR2=0;				//设置占空比
	TIM1->CCR3=0;				//设置占空比
	TIM1->CCR4=0;				//设置占空比
...
//***************************舵机转角控制***************************
//Servo1,	第一通道输出脉宽，数值范围500-2500
//Servo2,	第二通道输出脉宽，数值范围500-2500
//Servo3,	第三通道输出脉宽，数值范围500-2500
//Servo4,	第四通道输出脉宽，数值范围500-2500
void Set_Servo(int Servo1,int Servo2,int Servo3,int Servo4)
{
	TIM1->CCR1=Servo1;				//设置输出脉宽
	TIM1->CCR2=Servo2;				//设置输出脉宽
	TIM1->CCR3=Servo3;				//设置输出脉宽
	TIM1->CCR4=Servo4;				//设置输出脉宽
}
