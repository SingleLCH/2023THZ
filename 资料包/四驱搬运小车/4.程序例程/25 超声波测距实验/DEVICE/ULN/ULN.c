...
void Uln_init(void)
{
	...
	Trig=0;	
	TIM1_Int_Init(5000,720);//计数一个数值，时间为10us
...
void Uln_Trig(void)
{
	...
	if(TimeOut_Flag2)Distance2=500;	
	TimeOut_Flag1=1;	TimeOut_Flag2=1;
	TIM1->CNT=0;  			//设定计数器自动重装值 
...
{
	Distance1=TIM1->CNT;//声速为340m/s,一个计数时间为10us,那么声音传播的距离为0.0034m,即0.34cm
...
{
	Distance2=TIM7->CNT;//声速为340m/s,一个计数时间为10us,那么声音传播的距离为0.0034m,即0.34cm
	Distance2=Distance2*17/100-7; //单位0.1cm
	TimeOut_Flag2=0;
