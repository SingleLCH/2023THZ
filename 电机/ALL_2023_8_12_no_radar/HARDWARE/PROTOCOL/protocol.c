...
/****************************/
extern uint8_t keyup_first_flag;
/****************************/
...
void set_computer_value(uint8_t cmd, uint8_t ch, void *data, uint8_t num)
{
  ...
  HAL_UART_Transmit(&g_uart1_handle, (uint8_t *)&set_packet, sizeof(set_packet), 0xFFFFF);    // 发送数据头
  HAL_UART_Transmit(&g_uart1_handle, (uint8_t *)data, num, 0xFFFFF);                          // 发送参数
  HAL_UART_Transmit(&g_uart1_handle, (uint8_t *)&sum, sizeof(sum), 0xFFFFF);                  // 发送校验和
}
