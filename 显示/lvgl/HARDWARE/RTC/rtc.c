...
HAL_StatusTypeDef RTC_Set_Time(u8 hour,u8 min,u8 sec,u8 ampm)
{
	...
	RTC_TimeStructure.Hours=20;
	RTC_TimeStructure.Minutes=48;
	RTC_TimeStructure.Seconds=40;
...
HAL_StatusTypeDef RTC_Set_Date(u8 year,u8 month,u8 date,u8 week)
{
	...
	RTC_DateStructure.Month=0x04U;
	RTC_DateStructure.WeekDay=6;
...
{      
    ...
    { 
        RTC_Set_Time(20,12,56,RTC_HOURFORMAT12_PM);	        //设置时间 ,根据实际时间修改
		RTC_Set_Date(23,04,01,7);		                    //设置日期
